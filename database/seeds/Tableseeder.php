...
class Tableseeder extends Seeder
{
    public function run()
    {
       ...
       foreach($domains as $row){
        ...
        $domain_trans = [
            [ 'flag' => 'domain','attach_id' => $domain_id[0], 'client_id' => $client_ids[0],  'amount' => 500.00, 'year' => '23'],

             [ 'flag' => 'domain','attach_id' => $domain_id[1], 'client_id' => $client_ids[1],  'amount' => 800.00,'year' => '28'],
       ];
       ...
       $hosting = [
            ['client_id' => $client_ids[0], 'hosting_proviedr' => 'godaddy',  'start_date' => '2017-07-01', 'end_date' => '2020-07-01','hosting_type' => 'cloud', 'notes' => 'notes'],

            ['client_id' => $client_ids[1], 'hosting_proviedr' => 'abc provider',  'start_date' => '2017-07-17', 'end_date' => '2021-07-17','hosting_type' => 'dedicated', 'notes' => 'notes'],
       ];
       foreach($hosting as $row){
        ...
        $hosting_trans = [
            [ 'flag' => 'hosting','attach_id' => $hosting_id[0], 'client_id' => $client_ids[0],  'amount' => 600.00, 'year' => '3'],

             [ 'flag' => 'hosting','attach_id' => $hosting_id[1], 'client_id' => $client_ids[1],  'amount' => 900.00, 'year' => '4']
       ];
