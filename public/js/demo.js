...
$(document).ready(function(){
    //click function for hosting/domain renewal

    jQuery('.domain_renew_modal').click(function(){
      
      var x =
      jQuery(this).parent().parent().siblings('.expiry_date').text();
      var y = jQuery(this).parent().parent().siblings('.remaining_days').text();
      jQuery('#result_renew_modal').html('<b>Expires On: </b>'+x+' ('+y+' Days remaining)');
      
      var client_name = 
      jQuery(this).parent().parent().siblings('.client_name').text();
      jQuery('.result_client_name').html('<b>Client Name: </b>' +client_name);

      var creation_date = 
      jQuery(this).parent().parent().siblings('.creation_date').text();
      jQuery('.result_creation_date').html('<b> Renewed On: </b>' +creation_date);

      var amount =
      jQuery(this).parent().parent().siblings('.amount').text();
      jQuery('.result_amount').html('<b>Amount: </b>' +amount);
    });

    jQuery("#domain_renew_year").change(function(){
      
      var year = jQuery(this).val();
      jQuery('#total_year').html("<b>Domain will be renwed for : </b> "+year+" year(s)");
      var amount = 
      jQuery("#domain_renew_amount").val();
      var total_amount = year * amount;
      jQuery('#total_amount').html("<b>Total Amount To Be Paid </b>:"+total_amount+ " INR");
    });
    jQuery("#domain_renew_amount").change(function(){
      var amount = jQuery(this).val();
      var year = jQuery("#domain_renew_year").val();
      var total_amount = year * amount;
      jQuery('#total_amount').html("<b>Total Amount To Be Paid </b>:"+total_amount+ " INR");
    });

    jQuery('.hosting_renew_modal').click(function(){
      var x =
      jQuery(this).parent().parent().siblings('.expiry_date').text();
      var y = jQuery(this).parent().parent().siblings('.remaining_days').text();
      jQuery('#result_renew_modal').html('<b>Expires On: </b>'+x+' ('+y+' Days remaining)');
     ...
     jQuery("#hosting_renew_year").change(function(){
      var year = jQuery(this).val();
      jQuery('#total_year').html("<b>Hosting will be renwed for: </b> "+year+" year(s)");
      var amount = 
      jQuery("#hosting_renew_amount").val();
      var total_amount = year * amount;
      jQuery('#total_amount').html("<b>Total Amount To Be Paid </b>:"+total_amount+ " INR");
    });
    jQuery("#hosting_renew_amount").change(function(){
      var year =
      jQuery("#hosting_renew_year").val();
      var amount = jQuery(this).val();
